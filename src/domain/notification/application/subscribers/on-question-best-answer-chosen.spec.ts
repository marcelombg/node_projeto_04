...
import { SendNotificationUseCase, SendNotificationUseCaseRequest, SendNotificationUseCaseRequestResponse } from "../use-cases/send-notification"
...
let sendNotificationExecuteSpy: SpyInstance<[SendNotificationUseCaseRequest], Promise<SendNotificationUseCaseRequestResponse>>
...
describe('On Question Best Answer', () => {
    ...
    beforeEach(() => {
        ...
        sendNotificationUseCase = new SendNotificationUseCase(inMemoryNotificantionsRepository)
